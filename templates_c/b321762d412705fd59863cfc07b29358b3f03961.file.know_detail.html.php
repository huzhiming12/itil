<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-09-12 13:19:49
...
?>
        <p>
            ...
            <a href="javascript:void(0)" data-toggle="popover" data-placement="right" data-html="true" data-trigger="focus"
                       data-content="<button class='btn btn-sm btn-primary' onclick='window.location.href=&quot;/itildemo/plugins/fileupload/php/uploads/files/<?php echo $_smarty_tpl->tpl_vars['arr']->value['attach_id'];?>
/<?php echo $_smarty_tpl->tpl_vars['arr']->value['attach_md5_name'];?>
&quot;'>下载</button>&nbsp;&nbsp;
...
&file_name=<?php echo $_smarty_tpl->tpl_vars['arr']->value['attach_md5_name'];?>
...
&quot;'>删除</button>"><?php echo $_smarty_tpl->tpl_vars['arr']->value['attach_name'];?>
    ...
    <div class="_46_knowkedge">
        <?php if ($_smarty_tpl->tpl_vars['res']->value['kno_state']=='1') {?>
