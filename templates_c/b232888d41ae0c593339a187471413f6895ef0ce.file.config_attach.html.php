...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3013955ffa4799cab81-68208354',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_55ffa479a5c523_69122038',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55ffa479a5c523_69122038')) {function content_55ffa479a5c523_69122038($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <?php echo '<script'; ?>
...
<div class="_012_RequestList">
    ...
    <div class="_015_RequestList">
        <div class="_029_config_sort">当前配置：</div>
        <div class="_014_RequestList" style="line-height: 30px">
            单个文件最大是 <span style="color: red"><?php echo $_smarty_tpl->getConfigVariable('MaxFileSize')/1024/1024;?>
</span> M，
            同时最多上传 <span style="color: red"> <?php echo $_smarty_tpl->getConfigVariable('MaxFileCount');?>
</span>个文件<br>
            支持上传的文件格式：<?php echo $_smarty_tpl->getConfigVariable('extFilters');?>

        </div>
        <br>

        <div class="_029_config_sort">配置修改：</div>
        <form method="post" action="">
            <div class="_014_RequestList">
                <table class="form-group-sm">
                    <tr>
                        <td><label class="control-label">单个文件最大限制：</label></td>
                        <td><select class="form-control" name="file_size">
                        ...
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td><label class="control-label">同时上传文件个数：</label></td>
                        <td>
                            <select class="form-control" name="file_count">
                    ...
                    <tr>
                        <td><label>文件格式：</label></td>
                    </tr>
                </table>
                <div class="_014_RequestList">
                    <table class="form-group-sm btn-group" >
                ...
                <div class="_46_knowledge">
                    <button class="btn btn-sm btn-primary" type="submit" name="config_change">修改</button>
                    &nbsp;&nbsp;&nbsp;
