...
$sqltool = new SQLTool();
$res = $sqltool->dbQuery("select user_name,(select sum(req_complex*0.2+1) from t_req where req_finish_engineer=t_user.user_name) num from t_user where user_role=2 order by num desc");
