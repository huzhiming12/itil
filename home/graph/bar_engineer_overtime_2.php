...
$sqltool = new SQLTool();
$res = $sqltool->dbQuery("select user_name,(select sum(abs(req_time_left)/3600) from t_req_assign where req_time_left < 0 and  req_engineer=t_user.user_name $sql) num from t_user where user_role=2");
